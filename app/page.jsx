        ...
        <div className="container">
          ...
          <div className="hero-ad-card">
            <div className="ad-card-content">
              <h2>Türkiye’ye her yıl 50 milyondan fazla turist geliyor. Sizce turistler nereyi tercih ediyor?</h2>
              <ul className="ad-features">
                <li><span className="check-mark">✔</span> Kendi dillerinde menü sunan</li>
                <li><span className="check-mark">✔</span> Kolay ulaşılabilir</li>
                <li><span className="check-mark">✔</span> Güven veren işletmeler</li>
              </ul>
              <p>Kapırtı ile restoranınızı globalleştirin. <strong>3 dilde menü - Ücretsiz!</strong></p>
              <div className="ad-buttons">
                <a href="#" className="btn google-play-btn">Google Play</a>
              </div>
